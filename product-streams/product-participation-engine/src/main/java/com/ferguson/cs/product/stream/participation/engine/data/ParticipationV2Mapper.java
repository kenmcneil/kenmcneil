...
@Mapper
public interface ParticipationV2Mapper {
	 ...
	 */
	int takeV2PricesOffSaleAndApplyPendingBasePriceUpdates(int userId);
	 ...
	 * @return The number of records modified.
	 */
	int applyNewV2CalculatedDiscounts(Date processingDate, int userId, long coolOffPeriodMinutes);

	int insertParticipationV2CalculatedDiscounts(@Param("calculatedDiscounts") List<ParticipationCalculatedDiscount> calculatedDiscounts);
	 ...
	 * @return The number of records modified.
	 */
	int deleteParticipationV2CalculatedDiscounts(int participationId);

	/**
	 * store state of published discount and relate it to published participation version in history
	 */
	int insertParticipationV2CalculatedDiscountsHistory(
