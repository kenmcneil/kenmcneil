 ...
 */
public class ParticipationHistoryProcessor {
	private final static Logger LOG = LoggerFactory.getLogger(ParticipationHistoryProcessor.class);
	...
	public ParticipationHistoryProcessor(
