...
public interface AwsRequestSigner {
	...
	/**
	 * Update/Sign headers in provided HTTP request using Amazon AWS authorization
	 * protocol.
	 * 
	...
	/**
	 * Support option to specify whether host name gets explicitly set in the
	 * request header as may be required by some APIs (e.g., GE Product API).
	 * 
