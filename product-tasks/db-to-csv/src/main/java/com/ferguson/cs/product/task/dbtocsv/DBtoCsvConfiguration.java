...
public class DBtoCsvConfiguration {
	...
	private static final String BASE_MAPPER_PACKAGE = "com.ferguson.cs.product.task.dbtocsv.dao";
	private static final String BASE_ALIAS_PACKAGE = "com.ferguson.cs.product.task.dbtocsv.model";
